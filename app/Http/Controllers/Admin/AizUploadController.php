...
class AizUploadController extends Controller
{
    function __construct()
    {
        ...
        $this->middleware('permission:upload_files', ['only' => ['index','create','show_uploader','upload','get_uploaded_files','destroy','get_preview_files','attachment_download','file_info']]);
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
            Storage::delete('storage' . '/' . $upload->file_name);
            // unlink(public_path() . '/' . );
            $upload->delete();
            flash(trans('messages.file').trans('messages.deleted_msg'))->success();
        } catch (\Exception $e) {
            $upload->delete();
            flash(trans('messages.file').trans('messages.deleted_msg'))->success();
        }
    ...
    public function attachment_download($id)
    {
        ...
        try {
            ...
            flash(trans('messages.file_does_not_exist'))->error();
            return back();
        }
    }
    //Download project attachment
