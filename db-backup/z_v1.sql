...
--
-- Database: `tomsher2022_zena_kazena`
--
...
CREATE TABLE `addresses` (
  ...
  `country_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `brand_translations` (
  ...
  `og_title` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  `og_description` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `twitter_title` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `carts` (
  ...
  `offer_tag` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(111, 60, NULL, 35, 15, NULL, 1, 4300.00, 4300.00, NULL, '', 0.00, 0.00, 'free', 0.00, 0.00, NULL, 0, 0, '2024-12-20 18:07:59', '2024-12-20 18:08:09'),
...
CREATE TABLE `category_translations` (
  ...
  `twitter_title` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  `twitter_description` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `meta_keyword` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(4, NULL, 'cart_base', '10OFF', '{\"min_buy\":\"100000\",\"max_discount\":\"200\"}', 10.00, 'amount', 1733788800, 1735603200, 0, 0, '2024-12-05 16:42:06', '2024-12-20 17:45:25');
...
INSERT INTO `faqs` (`id`, `title`, `ar_title`, `content`, `ar_content`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Question 1 English edited', 'Question 1 arabic edited', '<p>Answer 1 english edited</p>', '<p>Answer 1 arabic edited</p>', 1, 1, '2024-02-20 21:06:33', '2024-02-21 13:25:11'),
(3, 'Question 2 english', 'Question 2 arabic', '<p>Answer 1 english</p>', '<p>Answer 2 arabic</p>', 2, 1, '2024-02-21 13:26:18', '2024-02-21 13:26:18');
...
CREATE TABLE `orders` (
  ...
  `billing_address` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `order_notes` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `delivery_status` varchar(20) COLLATE utf8_unicode_ci DEFAULT 'pending',
  `payment_type` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'cash_on_delivery, card, card_wallet\r\n',
  ...
  `payment_tracking_id` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `coupon_code` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `cancel_reason` text COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `return_reason` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(14, NULL, '20241204-09182027', 56, NULL, '{\"name\":\"Nimitha\",\"email\":\"test@gmail.com\",\"address\":\"Wafi Residence\",\"zipcode\":\"000000\",\"city\":\"Dubai\",\"phone\":\"5841542365\"}', '{\"name\":\"Nimitha\",\"email\":\"test@gmail.com\",\"address\":\"Wafi Residence\",\"zipcode\":\"000000\",\"city\":\"Dubai\",\"phone\":\"5841542365\"}', 'Urgent Requirement', 'confirmed', 'cod', 'un_paid', NULL, NULL, 'free_shipping', 0.00, 0.0000, 600000.00, 600000.00, 0.00, NULL, 0.00, NULL, NULL, 1733303900, 1, '2024-12-05 12:55:03', 0, NULL, 'High price', 0, NULL, 0, NULL, NULL, '2024-12-04 17:18:20', '2024-12-05 22:24:49'),
...
(21, NULL, '20241220-06202412', 60, NULL, '{\"name\":\"test user\",\"email\":\"nevetha.tomsher@gmail.com\",\"address\":\"dummy address\",\"zipcode\":\"152036\",\"city\":\"dubai\",\"phone\":\"0502563215\"}', '{\"name\":\"test user\",\"email\":\"nevetha.tomsher@gmail.com\",\"address\":\"dummy address\",\"zipcode\":\"152036\",\"city\":\"dubai\",\"phone\":\"0502563215\"}', '', 'pending', 'cod', 'un_paid', NULL, NULL, 'free_shipping', 0.00, 0.0000, 424300.00, 424300.00, 0.00, NULL, 0.00, NULL, NULL, 1734675624, 0, NULL, 0, NULL, NULL, 0, NULL, 0, NULL, NULL, '2024-12-20 14:20:24', '2024-12-20 14:20:24'),
...
(31, 21, 33, 12, '[]', 120000.00, 120000.00, 120000.00, 0.00, 0.00, 1, 'unpaid', 'pending', NULL, '2024-12-20 06:20:24', '2024-12-20 06:20:24'),
(32, 21, 35, 15, '[]', 4300.00, 4300.00, 4300.00, 0.00, 0.00, 1, 'unpaid', 'pending', NULL, '2024-12-20 06:20:24', '2024-12-20 06:20:24'),
(33, 21, 34, 13, '[{\"name\":\"Color\",\"value\":\"Gold\"}]', 300000.00, 300000.00, 300000.00, 0.00, 0.00, 1, 'unpaid', 'pending', NULL, '2024-12-20 06:20:24', '2024-12-20 06:20:24'),
...
CREATE TABLE `page_translations` (
  ...
  `heading1` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `content1` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `content2` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `heading3` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `content3` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `content4` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `content5` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `heading4` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `heading5` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `heading6` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `heading7` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `heading8` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `heading9` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `meta_title` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `meta_description` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `keywords` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `og_title` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `og_description` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `twitter_title` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `twitter_description` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `meta_image` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(21, 'manage_occasions', 'Manage Occasions', 'web', 1, NULL, NULL);
...
CREATE TABLE `products` (
  ...
  `type` enum('sale','rent','auction') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'sale',
...
(35, 'White Diamond Zircon Ring', 'DR152667', 'sale', 'white-diamond-zircon-ring', 0, NULL, NULL, 0, NULL, 'admin', 9, NULL, 5, 1, 3, 0.00, '/storage/products/2024/11/DR152667/main/DR152667_gallery_1.jpg,/storage/products/2024/11/DR152667/main/DR152667_gallery_2.jpg,/storage/products/2024/11/DR152667/main/DR152667_gallery_3.jpg,/storage/products/2024/11/DR152667/main/DR152667_gallery_4.jpg', '/storage/products/2024/11/DR152667/main/DR152667.jpeg', 'youtube', NULL, 0.00, NULL, NULL, 0, '[]', NULL, NULL, 1, 1, 1, 0, 0, 0, NULL, 1, NULL, 0.00, 'amount', NULL, NULL, NULL, NULL, 'flat_rate', NULL, NULL, 5, 0.00, 0, 0, '2024-11-25 19:05:39', '2024-12-20 16:23:27'),
...
CREATE TABLE `product_seos` (
  ...
  `og_title` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `og_description` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twitter_title` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(12, 33, NULL, 1, 'SKU00011', 120000.00, 0.00, 5, 120000.00, '', NULL, '2024-11-22 11:56:39', '2024-12-20 16:23:27'),
(13, 34, NULL, 1, 'SKU00010', 300000.00, 0.00, 7, 300000.00, '', '/storage/products/2024/11/SKU00010/SKU00010_gallery_1.jpg', '2024-11-22 14:14:32', '2024-12-23 17:01:15'),
...
(15, 35, NULL, 1, 'DR152667', 4300.00, 0.00, 5, 4300.00, '', NULL, '2024-11-25 19:05:39', '2024-12-20 16:23:27'),
...
(56, 60, NULL, 30, '2024-12-04 22:05:16', '2024-12-20 17:25:53'),
...
(87, 60, NULL, 39, '2024-12-05 19:15:23', '2024-12-05 19:15:23'),
...
CREATE TABLE `searches` (
  ...
  `temp_user_id` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(4, 'dhanya@tomsher.com', '2024-12-24 19:18:49', '2024-12-24 19:18:49');
...
CREATE TABLE `users` (
  ...
  `eid_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `eid_approval_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0-Pending, 1-Approved, 2-Denied',
  `eid_image_front` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `eid_image_back` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `otp` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(13, 'Vendor N', 'vendor.n@yopmail.com', 'dscdfvdfv#$%cv', NULL, NULL, NULL, NULL, '$2y$12$/bq.tG4SNfAPIU7tCu2DXO3Hs8Hicevrm4AhQ2TFhh/L176hwAs5G', NULL, 'N designs', 'fashion', 10.00, NULL, 'vendors/licenses/Nxt9TEFh7VnWV66mSdHNDjkJLVZvjgn0AyWjwN7B.jpg', 'test adres', 'vendors/logos/RotDIdQ4Hgh3Lt4iEDRDuFdSNrbqgU2AU7uySerz.webp', 1, 'pending', '2024-12-19 18:25:31', '2024-12-19 22:18:45');
