            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" method="POST" action="{{ route('banners.update', $banner) }}">
                    ...
                    <div class="form-group row @if ($lang != 'en') d-none @endif">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Name" value="{{ old('name', $banner->name) }}" id="name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input value="{{ old('banner', $banner->getTranslation('image', $lang)) }}" type="hidden"
                                    name="banner" class="selected-files" required>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Title"
                                value="{{ old('title', $banner->getTranslation('title', $lang)) }}" id="title"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Sub Title"
                                value="{{ old('sub_title', $banner->getTranslation('sub_title', $lang)) }}" id="sub_title"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Button Text"
                                value="{{ old('btn_text', $banner->getTranslation('btn_text', $lang)) }}" id="btn_text"
