<div class="shop-block-one" style="background-color: {{ get_setting('base_hov_color') }}; border-radius: 30px;">
    ...
    <div
        ...
        <div class="image-box relative block">
            <figure class="image relative block max-w-[180px] w-full mx-auto overflow-hidden">
                <a href="{!! $link !!}">
                    <img class="w-full transition-all duration-500 ease hover:scale-105" src="{{ $image }}"
                        alt="{{ $alt }}" />
                </a>
            </figure>
        </div>
        <div
            ...
            <h4 class="block text-xs leading-4 mb-1">
                <a class="inline-block text-[var(--title-color)] text-[11px] leading-4 h-[30px] overflow-hidden line-clamp-2"
                    href="{!! $link !!}">{!! $name !!}</a>
            </h4>
