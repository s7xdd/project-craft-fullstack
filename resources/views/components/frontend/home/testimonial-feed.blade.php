<section class="testimonial-section !py-20 ">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 !max-w-[1400px]">
        <div class="text-center mb-16">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 bg-clip-text text-transparent">
                {{ $title }}</h2>
        ...
        <div class="testimonial-carousel owl-carousel owl-theme owl-dots-none owl-nav-none" data-items="4"
