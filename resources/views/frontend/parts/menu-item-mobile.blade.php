...
@if($hasChildren)
    <li class="relative group">
        <div class="font-bold flex items-center justify-between">
            <a href="{{ $item->link }}" class="flex-1 text-white">{{ $item->label }}</a>
        ...
        <ul class="mt-2 min-w-[200px] px-4 bg-gray-800 shadow-lg rounded-lg py-2">
...
@else
    <li class="py-2">
        <a href="{{ $item->link }}" class="block text-gray-300 hover:text-blue-400 transition-colors">{{ $item->label }}</a>
    </li>
@endif
