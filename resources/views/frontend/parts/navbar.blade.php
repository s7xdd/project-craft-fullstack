...
@media (max-width: 767px) {
  ...
  .menu-right-content .search-inner {
    display: none;
  }
}
...
.mobile-search-popup .search-popup-overlay {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.mobile-search-popup .search-popup-content {
  position: absolute;
  top: 50%;
  left: 50%;
...
.mobile-search-popup .search-popup-header {
  display: flex;
  justify-content: space-between;
  align-items: center;
  margin-bottom: 20px;
...
.mobile-search-popup .search-popup-header h4 {
  margin: 0;
}

.mobile-search-popup .close-search-popup {
  background: none;
  border: none;
  font-size: 24px;
  cursor: pointer;
...
.mobile-search-popup .search-popup-body .form-group {
  position: relative;
}

.mobile-search-popup .search-popup-body input[type="search"] {
  width: 100%;
  padding: 10px;
...
.mobile-search-popup .search-popup-body button[type="submit"] {
  position: absolute;
  right: 10px;
  top: 50%;
...
<header class="main-header header-style-two">
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <div class="close-btn" id="close-mobile-menu"><i class="fas fa-times"></i></div>
        <nav class="menu-box">
            <div class="nav-logo">
                <a href="/">
