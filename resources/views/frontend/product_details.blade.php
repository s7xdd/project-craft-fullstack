    ...
    <x-frontend.product-detail.product-gallery>
                    ...
                    <x-slot name="cartOptions">
                        <div class="flex items-center space-x-4 pt-6">
                            <div class="flex items-center border border-gray-300 rounded-lg">
                                <button
                                    class="p-3 text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-l-lg transition-colors js-quantity-down">
                                ...
                                <button
                                    class="p-3 text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-r-lg transition-colors js-quantity-up">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                class="flex-1 bg-black text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors add-to-cart-btn"
        ...
        <div class="">
            <div class="product-gallery flex flex-col items-center">
                <!-- Main Image Slider -->
                <div class="embla overflow-hidden w-full max-w-2xl" id="product-image-carousel">
                        ...
                        @foreach ($response['photos'] as $index => $photo)
                            <div class="embla__slide flex-[0_0_100%] min-w-0 flex items-center justify-center">
                                <img src="{{ $photo }}" alt="Product Image {{ $index + 1 }}"
                                    class="w-full h-auto object-cover rounded-lg max-h-[500px] md:max-h-[5000px]"
                                    loading="lazy">
                            </div>
                        @endforeach
                    </div>
                            ...
                            <div class="swiper relatedProductsSwiper">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach ($chunk as $relProd)
                                        @php
                                            $imageRel =
                                                $relProd->thumbnail_img ??
                                                app('url')->asset('assets/img/placeholder.jpg');
                                        ...
                                        <div class="swiper-slide">
                                            <x-frontend.common.product-card image="{{ $imageRel }}"
                                                ...
                                                category="{{ $relProd->category->name ?? 'Category' }}"
                                                name="{{ $relProd->name }}"
                                ...
                                <button
                                    class="swiper-button-prev absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg text-gray-800 hover:bg-gray-50 transition-colors">
                                ...
                                <button
                                    class="swiper-button-next absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg text-gray-800 hover:bg-gray-50 transition-colors">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 5l7 7-7 7"></path>
                                    </svg>
