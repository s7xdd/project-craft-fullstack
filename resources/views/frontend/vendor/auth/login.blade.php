                                ...
                                <div class="login__container">
                                    ...
                                    <div class="login__d-flex">
                                        ...
                                        <div class="login__left">
                                            ...
                                            <!-- End login box -->
                                            <!-- Login box -->
                                            <div class="login__box js-new-register">
                                                <!-- Login heading -->
                                                ...
                                                <form>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" name="customer[first_name]"
                                                                    placeholder="First name" class="form-group__input">
                                                            </div>
                                                            <!-- End form group -->
                                                        </div>
                                                        <div class="col-6">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" name="customer[last_name]"
                                                                    placeholder="Last name" class="form-group__input">
                                                            </div>
                                                            <!-- End form group -->
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- Form group -->
                                                    <div class="form-group required">
                                                        <input type="password" required="required" name="customer[password]"
                                                            placeholder="Password" class="form-group__input">
                                                    </div>
                                                    <!-- End form group -->
                                                    <!-- Action -->
                                                    <div class="login__action"><input class="second-button" type="submit"
                                                            value="Create an account"></div>
                                                    <!-- End action -->
                                                    <div class="login__back"><a href="#"
                                                            class="js-login-back">Back</a></div>
                                                </form>
